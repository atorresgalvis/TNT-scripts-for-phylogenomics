...
![alt text](https://github.com/atorresgalvis/TNT-scripts-for-phylogenomics/blob/main/Fig1.png= 200x120 "Figure 1. Dialog box available when running CompileGenes.run from TNT windows menu version")
